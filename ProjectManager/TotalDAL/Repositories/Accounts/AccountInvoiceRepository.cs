...
namespace TotalDAL.Repositories.Accounts
{
    ...
    {
        public AccountInvoiceRepository(ProjectManagerEntities totalSalesPortalEntities)
    ...
    {
        public AccountInvoiceAPIRepository(ProjectManagerEntities totalSalesPortalEntities)
