...
namespace TotalDAL.Repositories
{
    public class BaseRepository : IBaseRepository
    {
        ...
        public BaseRepository(ProjectManagerEntities totalSalesPortalEntities)
        {
        ...
        protected ProjectManagerEntities TotalSalesPortalEntities { get { return this.totalSalesPortalEntities; } }
