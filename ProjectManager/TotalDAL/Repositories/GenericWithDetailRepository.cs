...
namespace TotalDAL.Repositories
{
        ...
        where TEntityDetail : class
    {
        ...
        public GenericWithDetailRepository(ProjectManagerEntities totalSalesPortalEntities)
            : this(totalSalesPortalEntities, null) { }

        public GenericWithDetailRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable)
            : this(totalSalesPortalEntities, functionNameEditable, null) { }

        public GenericWithDetailRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable, string functionNameApproved)
            : this(totalSalesPortalEntities, functionNameEditable, functionNameApproved, null) { }

        public GenericWithDetailRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable, string functionNameApproved, string functionNameDeletable)
            : this(totalSalesPortalEntities, functionNameEditable, functionNameApproved, functionNameDeletable, null) { }

        public GenericWithDetailRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable, string functionNameApproved, string functionNameDeletable, string functionNameVoidable)
