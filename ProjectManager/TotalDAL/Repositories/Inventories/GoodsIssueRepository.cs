...
namespace TotalDAL.Repositories.Inventories
{
    ...
    {
        public GoodsIssueRepository(ProjectManagerEntities totalSalesPortalEntities)
    ...
    {
        public GoodsIssueAPIRepository(ProjectManagerEntities totalSalesPortalEntities)
