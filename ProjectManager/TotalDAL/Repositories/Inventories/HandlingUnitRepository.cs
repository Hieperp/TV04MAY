...
namespace TotalDAL.Repositories.Inventories
{
    ...
    {
        public HandlingUnitRepository(ProjectManagerEntities totalSalesPortalEntities)
    ...
    {
        public HandlingUnitAPIRepository(ProjectManagerEntities totalSalesPortalEntities)
