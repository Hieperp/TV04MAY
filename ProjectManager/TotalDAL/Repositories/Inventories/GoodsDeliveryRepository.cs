...
namespace TotalDAL.Repositories.Inventories
{
    ...
    {
        public GoodsDeliveryRepository(ProjectManagerEntities totalSalesPortalEntities)
    ...
    {
        public GoodsDeliveryAPIRepository(ProjectManagerEntities totalSalesPortalEntities)
