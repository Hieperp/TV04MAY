...
namespace TotalDAL.Repositories
{
        ...
        where TEntity : class, IAccessControlAttribute //IAccessControlAttribute: for Loading (09/07/2015) - let review and optimize Loading laster
    {
        ...
        public GenericRepository(ProjectManagerEntities totalSalesPortalEntities)
            : this(totalSalesPortalEntities, null) { }

        public GenericRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable)
            : this(totalSalesPortalEntities, functionNameEditable, null) { }

        public GenericRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable, string functionNameApproved)
            : this(totalSalesPortalEntities, functionNameEditable, functionNameApproved, null) { }

        public GenericRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable, string functionNameApproved, string functionNameDeletable)
            : this(totalSalesPortalEntities, functionNameEditable, functionNameApproved, functionNameDeletable, null) { }

        public GenericRepository(ProjectManagerEntities totalSalesPortalEntities, string functionNameEditable, string functionNameApproved, string functionNameDeletable, string functionNameVoidable)
