...
namespace TotalDAL.Repositories.Commons
{
    ...
    {
        public EmployeeRepository(ProjectManagerEntities totalSalesPortalEntities)
            : base(totalSalesPortalEntities, "EmployeeEditable")
        {
        }
    ...
    {
        public EmployeeAPIRepository(ProjectManagerEntities totalSalesPortalEntities)
