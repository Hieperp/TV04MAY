...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Employee
    {
        ...
        public Employee(ProjectManagerEntities projectManagerEntities)
        {
        ...
        private void GetEmployeeIndexes()
        {
            ...
            this.projectManagerEntities.CreateStoredProcedure("GetEmployeeIndexes", queryString);
        }
        ...
        private void EmployeeEditable()
        {
            ...
            this.projectManagerEntities.CreateProcedureToCheckExisting("EmployeeEditable", queryArray);
        }
