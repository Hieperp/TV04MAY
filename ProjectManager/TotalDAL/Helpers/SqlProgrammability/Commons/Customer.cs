...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Customer
    {
        ...
        public Customer(ProjectManagerEntities projectManagerEntities)
        {
        ...
        private void GetCustomerIndexes()
        {
            ...
            this.projectManagerEntities.CreateStoredProcedure("GetCustomerIndexes", queryString);
        }
        ...
        private void CustomerEditable()
        {
            ...
            this.projectManagerEntities.CreateProcedureToCheckExisting("CustomerEditable", queryArray);
        }
