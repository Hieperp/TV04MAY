...
namespace TotalDTO.Commons
{
    ...
    public class CustomerBaseDTO : BaseDTO, ICustomerBaseDTO
    {
        ...
        public int TerritoryID { get { return 1; } set { } }
        [Display(Name = "Khu vực")]
        public virtual string EntireTerritoryEntireName { get; set; }

        [Required]
        public int SalespersonID { get { return 1; } set { } }
        ...
        public int PriceCategoryID { get { return 1; } set { } }
        [Display(Name = "Bảng giá")]
    ...
    public class CustomerPrimitiveDTO : CustomerBaseDTO, IPrimitiveEntity, IPrimitiveDTO
    {
        ...
        [DefaultValue(1)]
        public int CustomerCategoryID { get { return 1; } set { } }
        [Display(Name = "Phân loại khách hàng")]
        [DefaultValue(1)]
        public int CustomerTypeID { get { return 1; } set { } }
        //[Display(Name = "Khu vực")]
        ...
        public override string EntireTerritoryEntireName { get { return "#"; } set { } }

        [Required(ErrorMessage = "Vui lòng nhập tên nhân viên")]
        public override string SalespersonName { get { return "#"; } set { } }

        [Display(Name = "Hạn mức tín dụng")]
        public Nullable<double> LimitAmount { get; set; }

        [Display(Name = "Khách hàng")]
        public bool IsCustomer { get { return true; } set { } }
        [Display(Name = "Nhà cung cấp")]
        public bool IsSupplier { get; set; }
        [Display(Name = "Giới tính nữ")]
        public bool IsFemale { get; set; }

        public override int PreparedPersonID { get { return 1; } set { } }
    }
