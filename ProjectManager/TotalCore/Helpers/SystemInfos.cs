...
namespace TotalCore.Helpers
{
    public static class SystemInfos
    {
        public static bool Validate()
        {
            ...
            //string systemInfoDecrypt = SecureEncoding.Decrypt("LEMINHHIEP-AqSCdFEojixT1R7g9mYsC7P/RLTChZ2Y/nGSXg4MCCMoH+3cQ9mWmIc/ut8JYMX0uua5rejJyASktIBqHR/DiE3oy1QncbFDyGU2KtsPonCR8zk79MQENUIUvAWSivqIvKKyAHYRH45OvYD7B8+mANoCS2lhDFWMyE0Shn5h9wm2TNyVT7Nz04drLALpwgm436Zrrn6R9MEtnEf8jLGjUw=="); //VCP

            if (systemInfos == "9AjMX2WmdH1+f1gY28KOSIrnL3TmPUpAWOsRtqiPRqvMGh2ghwBv2xaZX73H9J2HdhsEjFDPEREvvqZWNMhmNZnwzIpQM0n+8sSgl7GDLB7KbU7rEjaLkIMwkLnkPwloByCwe9AtKMRrK1iCQ+dYyd4imAny4UmhqsMVIsnK207HIOLx4f+6gtGCtXzQTaZ+Rwk/zUdHfrcaJ9//o4GZ8g==" || systemInfos == "")
                return true;
            else
