    ...
    public static class NinjectWebCommon
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                kernel.Bind<ProjectManagerEntities>().ToSelf().InRequestScope();
                ...
                kernel.Bind<IProjectAPIRepository>().To<ProjectAPIRepository>();
                kernel.Bind<IProjectViewModelSelectListBuilder>().To<ProjectViewModelSelectListBuilder>();

                kernel.Bind<IEmployeeService>().To<EmployeeService>();
                kernel.Bind<IEmployeeRepository>().To<EmployeeRepository>();
                kernel.Bind<IEmployeeAPIRepository>().To<EmployeeAPIRepository>();
                kernel.Bind<IEmployeeViewModelSelectListBuilder>().To<EmployeeViewModelSelectListBuilder>();

                kernel.Bind<IPaymentTermService>().To<PaymentTermService>();
                kernel.Bind<IPaymentTermRepository>().To<PaymentTermRepository>();
                kernel.Bind<IPaymentTermAPIRepository>().To<PaymentTermAPIRepository>();
                kernel.Bind<IPaymentTermViewModelSelectListBuilder>().To<PaymentTermViewModelSelectListBuilder>();
